...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'kendy@wetk.net',
  ...
  protectedRoutes: ['/xxx', '/Demo/😎Another Private Folder Password 123'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'kendy@wetk.net',
